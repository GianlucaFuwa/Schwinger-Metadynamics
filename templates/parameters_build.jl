...
system["measure_dir"] = "./measurements/N$(physical["N"])/beta$(physical["β"])/Qlims$(meta["Qlims"])_Qthr$(meta["Qthr"])_dq$(meta["δq"])_w$(meta["w"])_build"
system["savebias_dir"] = "./metapotentials/N$(physical["N"])/beta$(physical["β"])"
system["biasfile"] = "Qlims$(meta["Qlims"])_Qthr$(meta["Qthr"])_dq$(meta["δq"])_w$(meta["w"])_build"
